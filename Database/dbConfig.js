...
const BASE_URL =
  process.env.NODE_ENVIRONMENT === "development"
    ...
    : `mongodb+srv://${process.env.PRODUCTION_MONGO_DB_USER_NAME}:${process.env.PRODUCTION_MONGO_DB_PASSWORD}@hallbookingdb.qqzxzcm.mongodb.net/${process.env.PRODUCTION_MONGO_DB_NAME}`;
